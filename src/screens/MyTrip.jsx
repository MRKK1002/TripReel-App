...
//             "https://images.unsplash.com/photo-1586968425481-3285b99f3b44?q=80&w=400"
//           ],
...
//           "people": 4,
//           "images": [
//             "https://images.unsplash.com/photo-1661921538251-4b63b1884019?q=80&w=400",
//             "https://images.unsplash.com/photo-1661881114924-536307040c49?q=80&w=400"
//           ],
...
//           "people": 2,
//           "images": [
//             "https://images.unsplash.com/photo-1585824435346-2b9f8246b115?q=80&w=400",
//             "https://images.unsplash.com/photo-1709811140788-521759256b0b?q=80&w=400"
//           ],
...
//             "https://images.unsplash.com/photo-1661894232140-73d96a67731b?q=80&w=400"
//           ],
...
//           "people": 2,
//           "images": [
//             "https://images.unsplash.com/photo-1493558103817-58b2924bce98?q=80&w=400",
//             "https://images.unsplash.com/photo-1493558103817-58b2924bce99?q=80&w=400"
//           ],
...
//   const destinations = ['Bangkok', 'Phuket', 'Phi Phi Islands', 'Krabi', 'Chiang Mai', 'Koh Samui'];
//   const places = ['Beaches', 'Temples', 'Markets', 'Islands', 'Mountains', 'Cultural Sites', 'Nightlife', 'Adventure Sports'];
//   const moods = [
//     { value: 'adventure', label: 'Adventure', icon: 'mountain' },
//     { value: 'cultural', label: 'Cultural', icon: 'compass' },
//     { value: 'honeymoon', label: 'Romantic', icon: 'heart' }
//   ];
...
//                     className="px-6 py-3 bg-indigo-600 rounded-lg"
//                   >
//                     <Text className="font-semibold text-center text-white">Try Again</Text>
//                   </TouchableOpacity>
//                 </View>
//               </View>
//             ) : (
...
//                   const pkg = category.packages[0];
//                   return (
//                     <View key={category.id} className="mb-6 overflow-hidden bg-white shadow-lg rounded-xl">
...
//                           <Text className="text-sm font-semibold text-white">{pkg.discount} OFF</Text>
//                         </View>
//                       </View>

//                       <View className="p-4">
//                         <Text className="mb-2 text-xl font-bold text-gray-800">{pkg.title}</Text>
//                         <Text className="mb-4 text-sm text-gray-600">{category.description}</Text>

//                         <View className="flex-row items-center justify-between mb-4">
//                           <Text className="text-2xl font-bold text-indigo-600">${pkg.price}</Text>
//                           <View className="flex-row items-center">
//                             <Icon name="users" size={16} color="#6B7280" />
//                             <Text className="ml-1 text-sm text-gray-500">{pkg.people} people</Text>
//                           </View>
//                         </View>

//                         <View className="mb-4">
//                           <Text className="mb-2 font-semibold text-gray-700">Includes:</Text>
//                           <View className="flex-row flex-wrap">
//                             {pkg.includes.slice(0, 4).map((item, idx) => (
//                               <View key={idx} className="flex-row items-center mb-1 mr-4">
//                                 <Icon name="check-circle" size={12} color="#10B981" />
//                                 <Text className="ml-1 text-sm text-green-600">{item}</Text>
//                               </View>
//                             ))}
//                           </View>
//                         </View>
...
//                         <View className="mb-4">
//                           <Text className="mb-2 font-semibold text-gray-700">Destinations:</Text>
//                           <View className="flex-row flex-wrap">
//                             {pkg.touristPlaces.slice(0, 3).map((place, idx) => (
//                               <View key={idx} className="px-2 py-1 mb-1 mr-2 bg-blue-100 rounded-full">
//                                 <Text className="text-xs text-blue-700">{place}</Text>
//                               </View>
//                             ))}
...
//                         <TouchableOpacity className="py-3 bg-indigo-600 rounded-lg">
...
//                 <TouchableOpacity
//                   key={dest}
//                   onPress={() => updatePreference('destination', dest)}
//                   className={`p-4 rounded-xl border-2 ${
//                     userPreferences.destination === dest
...
//               <TouchableOpacity
//                 onPress={() => updatePreference('people', Math.max(1, userPreferences.people - 1))}
//                 className="items-center justify-center w-12 h-12 bg-indigo-100 rounded-full"
//               >
//                 <Icon name="minus" size={20} color="#4F46E5" />
//               </TouchableOpacity>

//               <View className="px-6 py-4 bg-white border-2 border-indigo-200 rounded-xl">
...
//               <TouchableOpacity
//                 onPress={() => updatePreference('people', userPreferences.people + 1)}
//                 className="items-center justify-center w-12 h-12 bg-indigo-100 rounded-full"
//               >
//                 <Icon name="plus" size={20} color="#4F46E5" />
//               </TouchableOpacity>
//             </View>
//           </View>
//         );
...
//                     userPreferences.places.includes(place)
...
//                   {[200, 400, 600, 800, 1000, 1500, 2000].map((budget) => (
//                     <TouchableOpacity
//                       key={budget}
...
//                     name={mood.icon}
//                     size={24}
//                     color={userPreferences.mood === mood.value ? '#4F46E5' : '#6B7280'}
//                   />
...
//             <Icon name={questions[currentStep].icon} size={24} color="#4F46E5" />
//           </View>
...
//                 {currentStep === questions.length - 1 ? 'Find Trips' : 'Next'}
//               </Text>
//             </TouchableOpacity>
//           </View>
//         </View>
...
//   // Add a function to handle viewing AI recommendations
...
//   // Add a function to generate itinerary for a package
...
//   // In your MyTrip component, update the handleNext function:
//   const handleNext = async () => {
//     if (currentStep < questions.length - 1) {
//       setCurrentStep(currentStep + 1);
//     } else {
...
//         setShowResults(true);
//       } catch (error) {
//         // Even if the API fails, we'll have fallback recommendations
...
//   //  useEffect(() => {
//   //   if (loading2) {
//   //     // Simulate loader for 5 sec
//   //     const timer = setTimeout(() => setLoading2(false), 5000);
//   //     return () => clearTimeout(timer);
//   //   }
//   // }, []);

//   // And update the handleGenerateItinerary function:
//   const handleGenerateItinerary = async pkg => {
//     setLoading2(true);
//     try {
//       const itinerary = await getPersonalizedItinerary(pkg, userPreferences);
...
//   //   return (
//   //     <SafeAreaView className="flex-1 mt-16 mb-32 bg-blue-50">
//   //       <ScrollView className="flex-1">
//   //         <View className="px-4 py-6">
//   //           <View className="items-center mb-8">
//   //             <Text className="mb-2 text-3xl font-bold text-center text-gray-800">
...
//   //                       <TouchableOpacity className="py-3 bg-indigo-600 rounded-lg"     onPress={() => handleBookNow(pkg)}>
//   //                         <Text className="font-semibold text-center text-white">Book Now</Text>
//   //                       </TouchableOpacity>
//   //                     </View>
//   //                   </View>
...
//   // Update your results screen to include AI recommendations
//   // if (showResults) {
//   //   const matchingPackages = getMatchingPackages();
...
//   //     <SafeAreaView className="flex-1 mt-16 mb-32 bg-blue-50">
//   //       {loading && (
//   //         <View className="absolute inset-0 z-10 items-center justify-center bg-black bg-opacity-50">
...
//   //           {/* ... rest of your results rendering code */}

//   //           {/* Add Generate Itinerary button to each package */}
//   //           {matchingPackages.map(category => {
//   //             const pkg = category.packages[0];
//   //             return (
//   //               <View
...
//   //               >
//   //                 {/* ... your existing package rendering code */}
...
//             <View className="items-center">
//               <LottieView
//                 source={require('./../assets/Travel.json')} // your Lottie JSON
//                 autoPlay
//                 loop
//                 style={{ width: 300, height: 300 }}
//               />
...
//         {/* Header */}
//         <View className="items-center px-6 py-6 mt-12">
//           <View className="items-center justify-center w-16 h-16 mb-4 bg-indigo-100 rounded-full">
